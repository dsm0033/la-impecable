  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <StatCard icon={Users} label="Clientes" value={stats.clients} color="blue" />
        <StatCard icon={UserCheck} label="Empleados" value={stats.employees} color="green" />
        <StatCard icon={Wrench} label="Servicios" value={stats.services} color="yellow" />
      </div>
    </div>
  )
}
